			...
			<footer>
				...
				<div className={style.description}>
					<p className={style.blackText}>
						...
						Premium Reseller, где Вы можете купить iPhone
					</p>
					<p className={style.blackText}>Выберите свой iPhone в магазине i-Store</p>
					<p className={style.silverText}>
						Не знаете, какую модель iPhone выбрать? Наши онлайн-консультанты с радостью помогут
						вам найти телефон своей мечты. Если вы решите совершить покупку в Минске,
					</p>
